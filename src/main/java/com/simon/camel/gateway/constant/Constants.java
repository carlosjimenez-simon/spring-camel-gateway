...
public final class Constants {
	...
	public static final String SIMON_SPRING_CAMEL_ROUTE_ID_GATEWAY_GENERIC_GOOGLE_SHEET = "generic-google-sheet-gateway";
	public static final String SIMON_SPRING_CAMEL_ROUTE_ID_GATEWAY_GENERIC_COMPOSITION = "generic-composition-gateway";
	...
	public static final String SIMON_SPRING_CAMEL_ROUTE_ID_GOOGLE_SHEET = "simon-route-core-google-sheet";
	public static final String SIMON_SPRING_CAMEL_ROUTE_ID_COMPOSITION = "simon-route-core-composition";
	...
	public static final String SIMON_SPRING_CAMEL_ROUTE_ID_AUDIT_GOOGLE_SHEET = "simon-route-audit-google-sheet";
	public static final String SIMON_SPRING_CAMEL_ROUTE_ID_AUDIT_COMPOSITION = "simon-route-audit-composition";
	...
	public static final String SIMON_SPRING_CAMEL_ROUTE_BASE_GENERIC_GOOGLE_SHEET = "/api/v1/google-sheet";
	public static final String SIMON_SPRING_CAMEL_ROUTE_BASE_GENERIC_COMPOSITION = "/api/v1/composicion";
	/**end - Rutas Base*/
	...
	public static final String SIMON_SPRING_CAMEL_DIRECT_FROM_PROCESAR_GENERIC_GOOGLE_SHEET = "direct:process-generic-google-sheet";
	public static final String SIMON_SPRING_CAMEL_DIRECT_FROM_PROCESAR_GENERIC_COMPOSITION = "direct:process-generic-composition";
	...
	public static final String SIMON_SPRING_CAMEL_DIRECT_FROM_PROCESAR_AUDIT_GENERIC_GOOGLE_SHEET = "direct:audit-generic-google-sheet-s3";
	public static final String SIMON_SPRING_CAMEL_DIRECT_FROM_PROCESAR_AUDIT_GENERIC_COMPOSITION = "direct:audit-generic-composition-s3";
