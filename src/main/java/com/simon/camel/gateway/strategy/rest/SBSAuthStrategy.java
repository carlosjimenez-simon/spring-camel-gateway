...
@Slf4j
@Component
public class SBSAuthStrategy implements IRestSecurityStrategy {
    ...
    public void apply(Exchange exchange, Map<String, Object> headerConfig, Map<String, Object> datos) throws Exception {
        ...
        String appKey = secrets.get("appKey");
        String user = secrets.get("user");
        ...
        String authUrl = "https://devsyli.sbseguros.co/sbs-api-fileProcessing/api/auth";
